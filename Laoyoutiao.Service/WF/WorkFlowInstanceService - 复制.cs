...
{
    public class WorkFlowInstanceService_predict : BaseService<WF_WorkFlow_Instance>, IWorkFlowInstanceService
    {
        private readonly IMapper _mapper;
        private readonly ICapPublisher capPublisher;
        public WorkFlowInstanceService_predict(IMapper mapper, ICapPublisher capPublisher, CurrentUserCache cache) : base(mapper, cache)
        {
            this._mapper = mapper;
        ...
        public Task<List<WorkFlowNode>> GetExcuteNodes(string instanceid, string currentNodeId, int? isFinish = 1)
        {
            throw new NotImplementedException();
        }

        public Task<WorkFlowInstanceRes> GetWorkFlowInstanceByInstanceId(string instanceId)
        {
            throw new NotImplementedException();
        }

        public Task<WF_WorkFlow_Instance> ValidateAndGetInstanceAsync(string instanceId)
        {
            throw new NotImplementedException();
        }

        Task<WF_WorkFlow_Instance> IWorkFlowInstanceService.GetWorkFlowInstanceByInstanceId(string instanceId)
        {
            throw new NotImplementedException();
        }
